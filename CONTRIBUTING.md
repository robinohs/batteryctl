...
If you have ideas that affect the overall architecture of the tool or the behavior of already existing features, please open a new [discussion](https://github.com/robinohs/batteryctl/discussions/new/choose) first.
